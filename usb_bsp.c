...
//#define HOST_OVRCURR_LINE				GPIO_Pin_8
//#define HOST_OVRCURR_PORT_SOURCE		GPIO_PortSourceGPIOA
//#define HOST_OVRCURR_PIN_SOURCE			GPIO_PinSource8
//#define HOST_OVRCURR_PORT_RCC			RCC_APB2Periph_GPIOA
//#define HOST_OVRCURR_EXTI_LINE			EXTI_Line8
...
void  USB_OTG_BSP_ConfigVBUS(USB_OTG_CORE_HANDLE *pdev)
{
	...
	GPIO_SetBits(HOST_POWERSW_PORT, HOST_POWERSW_VBUS);	// 关断VBUS输出
